...
function ManageProperties() {
  ...
  const [properties, setProperties] = useState(cardData);
  ...
  return (
    <div className="w-[967px] mt-[88px] m-auto bg-black text-white">
      ...
      {properties.map((property) => (
        <div key={property.id} className="grid grid-cols-5 gap-4 w-[967px] items-center px-4 py-4 border-b border-[#FFFFFF99]">

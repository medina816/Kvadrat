...
<p className="w-full sm:w-[268px] lg:w-[675px] font-medium  text-[13px] lg:text-[20px] lg:font-semibold  lg:leading-7 text-white uppercase mt-0 lg:mt-[-10px] text-left lg:text-left lg:mr-[10px] lg:tracking-wider mr-[30px]">
  Выбирайте квартиру для жизни или инвестиций. Предложение доступно 
  <span className="bg-[#DC2215]  rounded-[1px] cursor-pointer text-white  sm:px-6 lg:mr-0 mr-[60px] lg:px-6   lg:ml-2 inline-block mt-1 lg:mt-0">

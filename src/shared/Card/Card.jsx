...
function Card() {
  return (
    <div className="w-[1435px] m-auto bg-black py-6 flex justify-center">
      <div className=" bg-black max-w-[1293px]">
        <div className="flex items-center justify-between gap-6 mb-8 px-4 lg:px-0 flex-wrap lg:flex-nowrap">
          ...
          <p className="w-full font-semibold text-base sm:text-lg lg:text-xl leading-5 sm:leading-7 lg:leading-7 text-white uppercase tracking-wider mt-0 lg:mt-[-10px] lg:w-[661px] text-center lg:text-left">
            Выбирайте квартиру для жизни или инвестиций. Предложение доступно
            <span className="bg-[#DC2215] cursor-pointer text-white px-4 sm:px-6  ml-2 inline-block mt-1 lg:mt-0">
